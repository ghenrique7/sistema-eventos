    ...
    <div class="flex items-center flex-col justify-center">
        ...
        <form action="{{ route('cadastro.store') }}" method="POST">
            ...
            <div class="grid gap-6 mb-6  md:grid-cols-3 ">
                <div>
                    ...
                    <input type="text" name="nome_usuario"
                        ...
                        placeholder="John" value="{{ old('nome_usuario') }}" required>
                </div>
                <div>
                    <label for="cpf" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">CPF</label>
                    <input type="text" name="cpf"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="00000000000" value="{{ old('cpf') }}" required>
                </div>
                <div>
                ...
                <div>
                    <label for="data_nascimento" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Data
                        de
                        Nascimento</label>
                ...
                <div>
                    ...
                    <input type="text" name="cep"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="00000000" value="{{ old('cep') }}" required>
                </div>
                <div>
                    <label for="cidade"
                    ...
                    <input type="text" name="cidade"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="Santarém" value="{{ old('cidade') }}" required>
                </div>
                <div>
                    <label for="estado"
                    ...
                    <input type="text" name="estado"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="PA" value="{{ old('estado') }}" required>
                </div>
                <div>
                    <label for="bairro"
                    ...
                    <input type="text" name="bairro"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="Aeroporto Velho" value="{{ old('bairro') }}" required>
                </div>
                <div>
                    <label for="numero"
                    ...
                    <input type="text" name="numero"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="0000" value="{{ old('numero') }}" required>
                </div>
                <div>
            ...
            <div>
                ...
                <a href="{{ route('login.index') }}" class="mx-4">Ja tenho uma conta</a>
            </div>
        </form>
